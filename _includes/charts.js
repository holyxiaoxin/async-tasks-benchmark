...
var data1 = {
  labels: ["0", "50", "100", "150", "200", "250", "300", "350", "400", "450", "500", "550", "600"],
  datasets: [
    {
      label: "Synchronous",
      ...
      data: [0, 1.219, 1.7474, 3.5988, 4.5904, 6.0892, 7.1681, 8.8981, 10.3327, 11.062, 12.3677, 14.0628, 13.6766]
    },
    {
      label: "ASynchronous",
      ...
      data: [0, 1.4351, 0.7572, 1.9704, 1.712, 2.1505, 2.6874, 3.6096, 4.0613, 3.7037, 4.3012, 4.1653, 4.1815]
    }
  ]
};
  ...
  datasets: [
    {
      ...
      data: [0, 1.1916, 2.5259, 3.6541, 4.8827, 6.1095, 6.4936, 9.1112, 10.2817, 11.6787, 13.4621, 14.0495, 16.1039]
    },
    {
      label: "ASynchronous",
      fillColor: "rgba(151,187,205,0.2)",
      ...
      pointHighlightFill: "#fff",
      pointHighlightStroke: "rgba(151,187,205,1)",
      data: [0, 0.4528, 0.8413, 1.3215, 1.8274, 2.0914, 2.3564, 2.7005, 3.2717, 3.5392, 3.8217, 4.2214, 4.9243]
    }
  ]
};
  ...
  datasets: [
    {
      ...
      data: [0, 1.1788, 2.4164, 3.822, 5.0605, 6.3205, 7.6368, 9.2475, 10.432, 11.7243, 12.6312, 13.9041, 14.6478]
    },
    {
      label: "ASynchronous",
      fillColor: "rgba(151,187,205,0.2)",
      ...
      pointHighlightFill: "#fff",
      pointHighlightStroke: "rgba(151,187,205,1)",
      data: [0, 0.4281, 0.8399, 1.2484, 1.608, 1.9235, 2.5216, 2.7484, 3.1631, 3.431, 3.9531, 4.4313, 4.5763]
    }
  ]
};
